...
> - 블럭요소의 가로길이/세로길이 적용시
> - auto : 요소의 기본 특성을 따라 감 / defaut 값 : 적용하지 않은 상태와 같음
> - px : px 값으로 고정
...
>   - Ex)
>   - (320px ~ 640px:s.p)(641px~1024px:t.b)(1025px~1920px:PC)
>   - (320px~799px:s.p)(800px~1920px:p.c)
>     '''
>     @medio screen and (max-width:1920px){
...
> absolute
>
> - 원래 위치의 자리를 유지하지 않고 부모의 기준으로 좌표 이동
> - 기본 : body을 기준
